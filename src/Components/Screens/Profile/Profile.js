    ...
    <ScrollView keyboardShouldPersistTaps="always">
      ...
      {successMessage ?
        (<View style={{alignItems: 'center'}}>
          <View
            style={{position: 'absolute', top: '20%', left: '16%', zIndex: 5}}>
      ...
      {errorMessage ?
        (<View style={{alignItems: 'center'}}>
          <View
            style={{position: 'absolute', top: '21%', left: '7%', zIndex: 5}}>
      ...
      <View style={styles.card}>
        <View style={styles.cardContent}>
          ...
          <TextInput
            style={styles.textInput}
            onChangeText={affiliationNumber =>
              setAffiliationNumber(affiliationNumber)
            }
