...
const Input = ({
  ...
  function _renderIconType(iconType, iconName, iconSize) {
    switch (iconType) {
      case 'Ionicons':
        return (
          <Ionicons name={iconName} style={styles.leftIcon} size={iconSize} />
        );
      case 'Zocial':
        return (
          <Zocial name={iconName} style={styles.leftIcon} size={iconSize} />
        );
      case 'Foundation':
        return (
          <Foundation name={iconName} style={styles.leftIcon} size={iconSize} />
        );
      default:
        return null;
    }
